...
#define UART_IXR_RTRIG         (1<<0)
#define UART_IXR_REMPTY        (1<<1)
#define UART_IXR_RFUL          (1<<2)
#define UART_IXR_TEMPTY        (1<<3)
#define UART_IXR_TFULL         (1<<4)
#define UART_IXR_IOVR          (1<<5)
#define UART_IXR_FRAME         (1<<6)
#define UART_IXR_PARE          (1<<7)
#define UART_IXR_TIMEOUT       (1<<8)
#define UART_IXR_DMSI          (1<<9)
#define UART_IXR_TIRIG         (1<<10)
#define UART_IXR_TNFULL        (1<<11)
#define UART_IXR_TOVER         (1<<12)
