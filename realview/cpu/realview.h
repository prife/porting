...
#define GIC_CPU_CTRL				__REG32(REALVIEW_GIC_CPU_BASE + 0x00)
#define GIC_CPU_PRIMASK				__REG32(REALVIEW_GIC_CPU_BASE + 0x04)
#define GIC_CPU_BINPOINT			__REG32(REALVIEW_GIC_CPU_BASE + 0x08)
#define GIC_CPU_INTACK				__REG32(REALVIEW_GIC_CPU_BASE + 0x0c)
#define GIC_CPU_EOI					__REG32(REALVIEW_GIC_CPU_BASE + 0x10)
#define GIC_CPU_RUNNINGPRI			__REG32(REALVIEW_GIC_CPU_BASE + 0x14)
#define GIC_CPU_HIGHPRI				__REG32(REALVIEW_GIC_CPU_BASE + 0x18)

#define GIC_DIST_CTRL				__REG32(REALVIEW_GIC_DIST_BASE + 0x000)
#define GIC_DIST_CTR				__REG32(REALVIEW_GIC_DIST_BASE + 0x004)
#define GIC_DIST_ENABLE_SET(n)		__REG32(REALVIEW_GIC_DIST_BASE + 0x100 + (n/32) * 4)
#define GIC_DIST_ENABLE_CLEAR(n)	__REG32(REALVIEW_GIC_DIST_BASE + 0x180 + (n/32) * 4)
#define GIC_DIST_PENDING_SET		__REG32(REALVIEW_GIC_DIST_BASE + 0x200)
#define GIC_DIST_PENDING_CLEAR		__REG32(REALVIEW_GIC_DIST_BASE + 0x280)
#define GIC_DIST_ACTIVE_BIT			__REG32(REALVIEW_GIC_DIST_BASE + 0x300)
#define GIC_DIST_PRI				__REG32(REALVIEW_GIC_DIST_BASE + 0x400)
#define GIC_DIST_TARGET(n)			__REG32(REALVIEW_GIC_DIST_BASE + 0x800 +  (n/4) * 4)
#define GIC_DIST_CONFIG(n)			__REG32(REALVIEW_GIC_DIST_BASE + 0xc00 + (n/16) * 4)
#define GIC_DIST_SOFTINT			__REG32(REALVIEW_GIC_DIST_BASE + 0xf00)
